...
module.exports = class Algorithm {
  ...
  // Create the encryptor/decryptor contexts
  encryptor(obj, key) {
    // key: A byte string containing the key to be used with this encryption
    // If the caller specifies th IV, it must be the correct length
    // If so, that IV will be used. If it is not specified
